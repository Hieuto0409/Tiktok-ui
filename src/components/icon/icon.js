export const MessageIcon = ({ width = 24, height = 24, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const HomeIconActive = ({ width = 32, height = 32, className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const FlowingIcon = ({ width = 32, height = 32, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const FlowingIconActive = ({ width = 32, height = 32, className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const LiveIconActive = ({ width = 32, height = 32, className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const IconX = ({ width = 16, height = 16, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const IconMusic = ({ width = 16, height = 16, className }) => (
    <svg
        width={width}
        height={height}
        className={className}
